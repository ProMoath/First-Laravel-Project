...
@section('content')
  ...
  <section class="section-margin--small section-margin">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <form action="{{ route('register.store') }}"  class="form-contact contact_form"  method="post" id="contactForm" novalidate="novalidate" action="contact_process.php">
...
{{--                    <x-input-error :messages="$errors->get('email')" class="mt-2" />--}}
            ...
            <div class="form-group text-center text-md-right mt-3">
                <a href="{{ route('login') }}" class="mx-3">Already Registered ?</a> <!--     we dont need to use theme.login because
                we have customized the ones in auth and used it      -->
