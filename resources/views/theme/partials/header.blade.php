@php
    ...
    $haederCategories = Category::take(2)->get();
@endphp
    <!--================Header Menu Area =================-->
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container box_1620">
                ...
                <a class="navbar-brand logo_h" href="{{ route('theme.index') }}"><img
                        src="{{asset('assest')}}/img/logo.png" alt=""></a>
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav justify-content-center">
                        ...
                        <li class="nav-item @yield('categories-active') submenu dropdown">
                            ...
                            @if(count($haederCategories) >0)

                            <ul class="dropdown-menu">
                                @foreach($haederCategories as $category)
                    ...
                    <ul class="nav navbar-nav navbar-right navbar-social">
                        @if(!Auth::check())
                            ...
                            <!--     we dont need to use theme.register because we have customized the ones in auth and used it      -->
                        @else
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="s{{route('theme.singleBlog')}}">My
                                            Blogs</a></li>
                                    <li class="nav-item">
