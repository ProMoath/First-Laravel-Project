        ...
        <div class="container">
            <div class="row">
                <div class="col-6 mx-auto">
                    <form action="{{route('login')}}" class="form-contact contact_form" method="post" novalidate="novalidate"> <!--action="contact_process.php"-->  <!--id="contactForm"-->
                    @csrf
                        ...
                        <div class="form-group text-center text-md-right mt-3">
                            ...
                            <!--     we dont need to use theme.register because
